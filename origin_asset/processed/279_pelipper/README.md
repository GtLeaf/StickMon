# 279 Pelipper PMD processing spec

This spec is intentionally scoped to Pelipper only.

## Source

- Input sheet: `origin_asset/source_sheets/medium/278_wingull_279_pelipper.png`
...
- Output root: `origin_asset/processed/279_pelipper/`
...
- Note: A wider canvas preserves fixed 2x scaling for the 31-pixel-wide moving poses.

## Contact sheet

- File: `pelipper_idle_walking_contact.png`.
...
- Scope: only species `279` uses this Pelipper state set.
