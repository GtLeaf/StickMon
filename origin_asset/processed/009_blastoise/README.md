# 9 Blastoise PMD processing spec

This spec is intentionally scoped to Blastoise only.

## Source

- Input sheet: `origin_asset/source_sheets/low/1/水箭龟.psd`
...
- Output root: `origin_asset/processed/009_blastoise/`
...
- Note: Walking crop boxes were derived from PSD layers walk0..walk4.
- Note: This source sheet has no separate idle action; idle uses walking frame 0 for each direction.
- Note: Sleeping uses row 2 sprites 4 and 5 from the original split PNG source.

## Contact sheet

- File: `blastoise_idle_walking_contact.png`.
...
- Scope: only species `9` uses this Blastoise state set.
