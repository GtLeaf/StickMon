# 197 Umbreon PMD processing spec

This spec is intentionally scoped to Umbreon only.

## Source

- Input sheet: `origin_asset/source_sheets/low/1/月伊布.psd`
...
- Output root: `origin_asset/processed/197_umbreon/`
...
- File: `umbreon_idle_walking_contact.png`.
...
- Scope: only species `197` uses this Umbreon state set.
