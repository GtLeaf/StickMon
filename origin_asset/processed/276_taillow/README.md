# 276 Taillow PMD processing spec

This spec is intentionally scoped to Taillow only.
...
- Output root: `origin_asset/processed/276_taillow/`
...
- File: `taillow_idle_walking_contact.png`.
...
- Scope: only species `276` uses this Taillow state set.
