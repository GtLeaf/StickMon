# 147 Dratini PMD processing spec

This spec is intentionally scoped to Dratini only.

## Source

- Input sheet: `origin_asset/source_sheets/high/147_dratini.png`
...
- Output root: `origin_asset/processed/147_dratini/`
...
- Note: Idle frames are sourced from walking frame 0 because this sheet has no separate idle action.

## Contact sheet

- File: `dratini_idle_walking_contact.png`.
...
- Scope: only species `147` uses this Dratini state set.
