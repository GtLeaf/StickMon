# 136 Flareon PMD processing spec

This spec is intentionally scoped to Flareon only.

## Source

- Input sheet: `origin_asset/source_sheets/high/136_flareon.png`
...
- Output root: `origin_asset/processed/136_flareon/`
...
- File: `flareon_idle_walking_contact.png`.
- Top-left label: output frame size, `frame 64x64 px`.
- Columns: exported directions in the order above.
- Rows: `idle_0`, `idle_1`, `idle_2`, `walking_0`, `walking_1`, `walking_2`, `walking_3`, `sleeping_0`, `sleeping_1`.
...
- Scope: only species `136` uses this Flareon state set.
