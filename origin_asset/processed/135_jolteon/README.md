# 135 Jolteon PMD processing spec

This spec is intentionally scoped to Jolteon only.

## Source

- Input sheet: `origin_asset/source_sheets/high/135_jolteon.png`
...
- Output root: `origin_asset/processed/135_jolteon/`
...
- File: `jolteon_idle_walking_contact.png`.
...
- Scope: only species `135` uses this Jolteon state set.
