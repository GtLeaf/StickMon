# 1 Bulbasaur PMD processing spec

This spec is intentionally scoped to Bulbasaur only.

## Source

- Input sheet: `origin_asset/source_sheets/low/1/妙蛙种子.psd`
...
- Output root: `origin_asset/processed/001_bulbasaur/`
...
- Note: This source sheet has no separate idle action; idle uses walk0 for each direction.
- Note: Crop boxes were derived from PSD layers walk0..walk4 and sleeping.

## Contact sheet

- File: `bulbasaur_idle_walking_contact.png`.
...
- Scope: only species `1` uses this Bulbasaur state set.
