# 123 Scyther PMD processing spec

This spec is intentionally scoped to Scyther only.
...
- Output root: `origin_asset/processed/123_scyther/`
...
- File: `scyther_idle_walking_contact.png`.
...
- Scope: only species `123` uses this Scyther state set.
