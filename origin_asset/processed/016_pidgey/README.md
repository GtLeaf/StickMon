# 16 Pidgey PMD processing spec

This spec is intentionally scoped to Pidgey only.

## Source

- Input sheet: `origin_asset/source_sheets/low/split_by_species/016_pidgey.png`
...
- Output root: `origin_asset/processed/016_pidgey/`
...
- File: `pidgey_idle_walking_contact.png`.
...
- Scope: only species `16` uses this Pidgey state set.
