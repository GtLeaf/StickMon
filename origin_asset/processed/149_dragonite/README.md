# 149 Dragonite PMD processing spec

This spec is intentionally scoped to Dragonite only.

## Source

- Input sheet: `origin_asset/source_sheets/high/149_dragonite.png`
...
- Output root: `origin_asset/processed/149_dragonite/`
...
- Note: The source sheet labels the movement action as Moving; project assets store it as walking for state-machine compatibility.

## Contact sheet

- File: `dragonite_idle_walking_contact.png`.
...
- Scope: only species `149` uses this Dragonite state set.
