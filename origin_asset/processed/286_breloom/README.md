# 286 Breloom PMD processing spec

This spec is intentionally scoped to Breloom only.

## Source

- Input sheet: `origin_asset/source_sheets/medium/285_shroomish_286_breloom.png`
...
- Output root: `origin_asset/processed/286_breloom/`
...
- Note: A 64x70 canvas preserves fixed 2x scaling and a transparent top margin for the tallest moving pose.

## Contact sheet

- File: `breloom_idle_walking_contact.png`.
- Top-left label: output frame size, `frame 64x70 px`.
...
- Scope: only species `286` uses this Breloom state set.
