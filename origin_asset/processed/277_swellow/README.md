# 277 Swellow PMD processing spec

This spec is intentionally scoped to Swellow only.

## Source

- Input sheet: `origin_asset/source_sheets/medium/276_taillow_277_swellow.png`
...
- Output root: `origin_asset/processed/277_swellow/`
...
- File: `swellow_idle_walking_contact.png`.
...
- Scope: only species `277` uses this Swellow state set.
