# 12 Butterfree PMD processing spec

This spec is intentionally scoped to Butterfree only.

## Source

- Input sheet: `origin_asset/source_sheets/low/012_butterfree.png`
...
- Output root: `origin_asset/processed/012_butterfree/`
...
- Note: Sleeping uses sprites 2 and 3 on row 2.
...
- File: `butterfree_idle_walking_contact.png`.
...
- Scope: only species `12` uses this Butterfree state set.
