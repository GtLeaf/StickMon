# 261 Poochyena PMD processing spec

This spec is intentionally scoped to Poochyena only.
...
- Output root: `origin_asset/processed/261_poochyena/`
...
- File: `poochyena_idle_walking_contact.png`.
...
- Scope: only species `261` uses this Poochyena state set.
