# 285 Shroomish PMD processing spec

This spec is intentionally scoped to Shroomish only.
...
- Output root: `origin_asset/processed/285_shroomish/`
...
- Note: Sleeping uses the third-last and second-last sprites on row 2, before the shadow sprite.
- Note: Only five source directions are exported; right-side directions are mirrored at runtime.

## Contact sheet

- File: `shroomish_idle_walking_contact.png`.
...
- Scope: only species `285` uses this Shroomish state set.
