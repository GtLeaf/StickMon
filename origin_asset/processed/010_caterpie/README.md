# 10 Caterpie PMD processing spec

This spec is intentionally scoped to Caterpie only.

## Source

- Input sheet: `origin_asset/source_sheets/low/010_caterpie.png`
...
- Output root: `origin_asset/processed/010_caterpie/`
...
- Note: Sleeping uses the fourth-last and third-last sprites on row 1, in left-to-right order.
...
- File: `caterpie_idle_walking_contact.png`.
...
- Scope: only species `10` uses this Caterpie state set.
