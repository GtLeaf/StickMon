# 194 Wooper PMD processing spec

This spec is intentionally scoped to Wooper only.
...
- Output root: `origin_asset/processed/194_wooper/`
...
- Note: The first 15 sprites on row 1 are moving frames: five directions, three frames each; the remaining nine row sprites are not exported.
...
- File: `wooper_idle_walking_contact.png`.
- File: `wooper_attack_contact.png`.
...
- Scope: only species `194` uses this Wooper state set.
