# 25 Pikachu PMD processing spec

This spec is intentionally scoped to Pikachu only.
...
- Output root: `origin_asset/processed/025_pikachu/`
...
- File: `pikachu_idle_walking_contact.png`.
...
- Scope: only species `25` uses this Pikachu state set.
