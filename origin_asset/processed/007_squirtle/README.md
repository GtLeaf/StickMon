# 7 Squirtle PMD processing spec

This spec is intentionally scoped to Squirtle only.

## Source

- Input sheet: `origin_asset/source_sheets/low/007_squirtle.png`
...
- Output root: `origin_asset/processed/007_squirtle/`
...
- Note: Sleeping uses row 2 sprites 15 and 16.

## Contact sheet

- File: `squirtle_idle_walking_contact.png`.
...
- Scope: only species `7` uses this Squirtle state set.
