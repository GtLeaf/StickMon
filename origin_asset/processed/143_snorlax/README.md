# 143 Snorlax PMD processing spec

This spec is intentionally scoped to Snorlax only.

## Source

- Input sheet: `origin_asset/source_sheets/high/143_snorlax.png`
...
- Output root: `origin_asset/processed/143_snorlax/`
...
- Note: Idle uses the second Idle/Moving frame (`walk1`) because this sheet shares idle and moving art.

## Contact sheet

- File: `snorlax_idle_walking_contact.png`.
...
- Scope: only species `143` uses this Snorlax state set.
