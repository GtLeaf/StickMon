# 8 Wartortle PMD processing spec

This spec is intentionally scoped to Wartortle only.

## Source

- Input sheet: `origin_asset/source_sheets/low/008_wartortle.png`
...
- Output root: `origin_asset/processed/008_wartortle/`
...
- File: `wartortle_idle_walking_contact.png`.
...
- Scope: only species `8` uses this Wartortle state set.
