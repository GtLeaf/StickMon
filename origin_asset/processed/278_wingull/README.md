# 278 Wingull PMD processing spec

This spec is intentionally scoped to Wingull only.
...
- Output root: `origin_asset/processed/278_wingull/`
...
- File: `wingull_idle_walking_contact.png`.
...
- Scope: only species `278` uses this Wingull state set.
