# 212 Scizor PMD processing spec

This spec is intentionally scoped to Scizor only.

## Source

- Input sheet: `origin_asset/source_sheets/high/212_scizor.png`
...
- Output root: `origin_asset/processed/212_scizor/`
...
- File: `scizor_idle_walking_contact.png`.
...
- Scope: only species `212` uses this Scizor state set.
