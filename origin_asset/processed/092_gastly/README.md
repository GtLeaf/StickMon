# 92 Gastly PMD processing spec

This spec is intentionally scoped to Gastly only.

## Source

- Input sheet: `origin_asset/source_sheets/low/092_gastly.png`
...
- Output root: `origin_asset/processed/092_gastly/`
...
- Note: Sleeping uses row 2 sprites 7 and 8.

## Contact sheet

- File: `gastly_idle_walking_contact.png`.
...
- Scope: only species `92` uses this Gastly state set.
