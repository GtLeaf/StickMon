# 94 Gengar PMD processing spec

This spec is intentionally scoped to Gengar only.

## Source

- Input sheet: `origin_asset/source_sheets/low/094_gengar.png`
...
- Output root: `origin_asset/processed/094_gengar/`
...
- Note: Sleeping uses row 2 sprites counted from the end: 10 and 9.

## Contact sheet

- File: `gengar_idle_walking_contact.png`.
...
- Scope: only species `94` uses this Gengar state set.
