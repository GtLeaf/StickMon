# 6 Charizard PMD processing spec

This spec is intentionally scoped to Charizard only.

## Source

- Input sheet: `origin_asset/source_sheets/low/1/喷火龙.psd`
...
- Output root: `origin_asset/processed/006_charizard/`
...
- File: `charizard_idle_walking_contact.png`.
...
- Scope: only species `6` uses this Charizard state set.
