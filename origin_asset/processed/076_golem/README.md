# 76 Golem PMD processing spec

This spec is intentionally scoped to Golem only.

## Source

- Input sheet: `origin_asset/source_sheets/low/076_golem.png`
...
- Output root: `origin_asset/processed/076_golem/`
...
- Note: Sleeping uses the ninth-last and eighth-last sprites on row 2, in left-to-right order.
...
- File: `golem_idle_walking_contact.png`.
...
- Scope: only species `76` uses this Golem state set.
