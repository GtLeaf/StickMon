# 17 Pidgeotto PMD processing spec

This spec is intentionally scoped to Pidgeotto only.

## Source

- Input sheet: `origin_asset/source_sheets/low/split_by_species/017_pidgeotto.png`
...
- Output root: `origin_asset/processed/017_pidgeotto/`
...
- Scope: only species `17` uses this Pidgeotto state set.
