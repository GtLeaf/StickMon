# 11 Metapod PMD processing spec

This spec is intentionally scoped to Metapod only.

## Source

- Input sheet: `origin_asset/source_sheets/low/011_metapod.png`
...
- Output root: `origin_asset/processed/011_metapod/`
...
- Note: Sleeping uses the third-last and second-last sprites on row 1, in left-to-right order.
...
- File: `metapod_idle_walking_contact.png`.
...
- Scope: only species `11` uses this Metapod state set.
