# 4 Charmander PMD processing spec

This spec is intentionally scoped to Charmander only.

## Source

- Input sheet: `origin_asset/source_sheets/low/1/小火龙.psd`
...
- Output root: `origin_asset/processed/004_charmander/`
...
- File: `charmander_idle_walking_contact.png`.
...
- Scope: only species `4` uses this Charmander state set.
