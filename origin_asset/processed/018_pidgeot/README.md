# 18 Pidgeot PMD processing spec

This spec is intentionally scoped to Pidgeot only.

## Source

- Input sheet: `origin_asset/source_sheets/low/split_by_species/018_pidgeot.png`
...
- Output root: `origin_asset/processed/018_pidgeot/`
...
- File: `pidgeot_idle_walking_contact.png`.
...
- Scope: only species `18` uses this Pidgeot state set.
