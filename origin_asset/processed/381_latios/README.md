# 381 Latios PMD processing spec

This spec is intentionally scoped to Latios only.

## Source

- Input sheet: `origin_asset/source_sheets/high/381_latios.png`
...
- Output root: `origin_asset/processed/381_latios/`
...
- Scope: only species `381` uses this Latios state set.
