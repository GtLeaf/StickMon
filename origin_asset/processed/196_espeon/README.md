# 196 Espeon PMD processing spec

This spec is intentionally scoped to Espeon only.

## Source

- Input sheet: `origin_asset/source_sheets/low/1/太阳伊布.psd`
...
- Output root: `origin_asset/processed/196_espeon/`
...
- File: `espeon_idle_walking_contact.png`.
...
- Scope: only species `196` uses this Espeon state set.
