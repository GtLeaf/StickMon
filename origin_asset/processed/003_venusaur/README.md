# 3 Venusaur PMD processing spec

This spec is intentionally scoped to Venusaur only.

## Source

- Input sheet: `origin_asset/source_sheets/low/psd/妙蛙花.psd`
...
- Output root: `origin_asset/processed/003_venusaur/`
...
- File: `venusaur_idle_walking_contact.png`.
...
- Scope: only species `3` uses this Venusaur state set.
