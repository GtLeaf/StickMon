# 2 Ivysaur PMD processing spec

This spec is intentionally scoped to Ivysaur only.

## Source

- Input sheet: `origin_asset/source_sheets/low/psd/妙蛙草.psd`
...
- Output root: `origin_asset/processed/002_ivysaur/`
...
- File: `ivysaur_idle_walking_contact.png`.
...
- Scope: only species `2` uses this Ivysaur state set.
