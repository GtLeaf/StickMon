# 42 Golbat PMD processing spec

This spec is intentionally scoped to Golbat only.

## Source

- Input sheet: `origin_asset/source_sheets/low/042_golbat.png`
...
- Output root: `origin_asset/processed/042_golbat/`
...
- Note: Sleeping uses the seventh-last and sixth-last sprites, kept in left-to-right order.
...
- Note: A 68x64 canvas preserves fixed 2x scaling for the widest sleeping pose.

## Contact sheet

- File: `golbat_idle_walking_contact.png`.
- Top-left label: output frame size, `frame 68x64 px`.
...
- Scope: only species `42` uses this Golbat state set.
