# 133 Eevee PMD processing spec

This spec is intentionally scoped to Eevee only.

## Source

- Input sheet: `origin_asset/source_sheets/high/133_eevee.png`
...
- Output root: `origin_asset/processed/133_eevee/`
...
- File: `eevee_idle_walking_contact.png`.
...
- Scope: only species `133` uses this Eevee state set.
