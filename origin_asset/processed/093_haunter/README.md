# 93 Haunter PMD processing spec

This spec is intentionally scoped to Haunter only.

## Source

- Input sheet: `origin_asset/source_sheets/low/093_haunter.png`
...
- Output root: `origin_asset/processed/093_haunter/`
...
- Note: Sleeping uses row 2 sprites 10 and 9, following the source note order.

## Contact sheet

- File: `haunter_idle_walking_contact.png`.
...
- Scope: only species `93` uses this Haunter state set.
