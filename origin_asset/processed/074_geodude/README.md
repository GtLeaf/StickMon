# 74 Geodude PMD processing spec

This spec is intentionally scoped to Geodude only.

## Source

- Input sheet: `origin_asset/source_sheets/low/074_geodude.png`
...
- Output root: `origin_asset/processed/074_geodude/`
...
- File: `geodude_idle_walking_contact.png`.
...
- Scope: only species `74` uses this Geodude state set.
