# 41 Zubat PMD processing spec

This spec is intentionally scoped to Zubat only.

## Source

- Input sheet: `origin_asset/source_sheets/low/041_zubat.png`
...
- Output root: `origin_asset/processed/041_zubat/`
...
- File: `zubat_idle_walking_contact.png`.
...
- Scope: only species `41` uses this Zubat state set.
