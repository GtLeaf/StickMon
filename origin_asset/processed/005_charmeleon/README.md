# 5 Charmeleon PMD processing spec

This spec is intentionally scoped to Charmeleon only.

## Source

- Input sheet: `origin_asset/source_sheets/low/1/火恐龙.psd`
...
- Output root: `origin_asset/processed/005_charmeleon/`
...
- File: `charmeleon_idle_walking_contact.png`.
...
- Scope: only species `5` uses this Charmeleon state set.
