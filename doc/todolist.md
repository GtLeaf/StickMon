1.背包物品分类 ✅ 2026-07-27 已完成：商店「日常」新增美味粮+甜/辣/酸/苦/涩五种口味粮，「探险」新增解麻/解眠/灼伤/解冻四药（解毒药收窄为仅解毒）；背包（MenuScene）与战斗背包同步支持新物品使用；当前 SAVE_VERSION 为 2，并保留 v1→v2 迁移；设计文档 §6.4 已同步
